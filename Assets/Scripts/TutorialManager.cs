...
public class TutorialManager : MonoBehaviour
{
	...
	//private List<KeyCode> inputItems = new List<KeyCode>();
	...
	//{
	//	inputItems.Add(KeyCode.E);
	//	inputItems.Add(KeyCode.W);
	//	inputItems.Add(KeyCode.A);
	//	inputItems.Add(KeyCode.D);
	//	inputItems.Add(KeyCode.LeftShift);
	//	inputItems.Add(KeyCode.Q);
	//	inputItems.Add(KeyCode.Space);
	//}
